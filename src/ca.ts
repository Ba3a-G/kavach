...
export class CA {
    ...
    public generateAadhaarCertificate(csrData: AadhaarCSRData, userPublicKeyBytes: Uint8Array): AadhaarCertificateRaw {
    ...
    public static verifyAadhaarCertificate(certificate: AadhaarCertificateRaw, govPublicKey: string): boolean {
    ...
    public encodeAadhaarCertificateToPEM(certificate: AadhaarCertificateRaw): string {
    ...
    public decodeAadhaarCertificateFromPEM(pemString: string): AadhaarCertificateRaw {
